...
class NapCatClientGenerated:
    """
    这是 NapCatClient 的自动生成基类。
    它包含了所有从 OpenAPI Schema 解析出的显式 API 方法。
    """
    ...
    async def call_action(self, action: str, params: Mapping[str, Any] | None = None) -> Any:
        ...
        子类必须实现此方法。
        """
        raise NotImplementedError("NapCatClient 必须实现 call_action")
    ...
    async def get_mini_app_ark_post_request_get_mini_app_ark(self, **kwargs: Unpack[GetMiniAppArkPostRequestGetMiniAppArkPostRequest]) -> dict[str, Any]:
        ...
        未提供描述。
        """
        return await self.call_action("get_mini_app_ark_post_request_get_mini_app_ark", kwargs)
