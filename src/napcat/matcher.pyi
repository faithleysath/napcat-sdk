...
class Predicate[T]:
    ...
    def __rand__(
        self, other: Callable[[T], bool] | Predicate[T], /
    ) -> Predicate[T]: ...
...
class BotOfflineEventPattern(TypedDict, total=False):
    ...
    tag: (
        Literal["BotOfflineEvent"]
        | str
        | PredicateLike[Literal["BotOfflineEvent"] | str]
    )
    message: (
        Literal["BotOfflineEvent"]
        | str
...
class GroupDecreaseEventPattern(TypedDict, total=False):
    ...
    user_id: int | PredicateLike[int]
    sub_type: (
        Literal["leave", "kick", "kick_me", "disband"]
        | PredicateLike[Literal["leave", "kick", "kick_me", "disband"]]
    )
    operator_id: int | PredicateLike[int]
...
class GroupMessageEventPattern(TypedDict, total=False):
    ...
    self_id: int | PredicateLike[int]
    post_type: (
        Literal["message", "message_sent"]
        | tuple[str, str]
        | PredicateLike[Literal["message", "message_sent"] | tuple[str, str]]
    )
    message_id: int | PredicateLike[int]
    ...
    message: (
        tuple[Message | UnknownMessageSegment, ...]
        | PredicateLike[tuple[Message | UnknownMessageSegment, ...]]
    )
    ...
    sub_type: (
        Literal["normal"] | str | None | PredicateLike[Literal["normal"] | str | None]
    )
    raw: Any | None | PredicateLike[Any | None]
    emoji_likes_list: (
        list[EmojiLikeItem] | None | PredicateLike[list[EmojiLikeItem] | None]
    )
    group_id: int | PredicateLike[int]
...
class GroupMsgEmojiLikeEventPattern(TypedDict, total=False):
    ...
    post_type: Literal["notice"] | PredicateLike[Literal["notice"]]
    notice_type: (
        Literal["group_msg_emoji_like"] | PredicateLike[Literal["group_msg_emoji_like"]]
    )
    group_id: int | PredicateLike[int]
    user_id: int | PredicateLike[int]
    message_id: int | PredicateLike[int]
...
class GroupRequestEventPattern(TypedDict, total=False):
    ...
    user_id: int | PredicateLike[int]
    sub_type: (
        Literal["add", "invite"] | str | PredicateLike[Literal["add", "invite"] | str]
    )
    comment: str | PredicateLike[str]
    flag: str | PredicateLike[str]
...
class InputStatusEventPattern(TypedDict, total=False):
    ...
    status_text: (
        Literal["对方正在输入..."]
        | str
        | PredicateLike[Literal["对方正在输入..."] | str]
    )
...
class LifecycleMetaEventPattern(TypedDict, total=False):
    ...
    sub_type: (
        Literal["enable", "disable", "connect"]
        | PredicateLike[Literal["enable", "disable", "connect"]]
    )
...
class MessageEventPattern(TypedDict, total=False):
    ...
    message_sent_type: str | None | PredicateLike[str | None]
    sub_type: (
        Literal["friend", "group", "normal"]
        | str
        | None
        | PredicateLike[Literal["friend", "group", "normal"] | str | None]
    )
    raw: Any | None | PredicateLike[Any | None]
    emoji_likes_list: (
        list[EmojiLikeItem] | None | PredicateLike[list[EmojiLikeItem] | None]
...
class MessageSenderPattern(TypedDict, total=False):
    ...
    role: (
        ...
        | str
        | None
        | PredicateLike[Literal["owner", "admin", "member"] | str | None]
    )
    sex: (
        Literal["male", "female", "unknown"]
        | str
        | None
        | PredicateLike[Literal["male", "female", "unknown"] | str | None]
    )
...
class OnlineFileReceiveEventPattern(TypedDict, total=False):
    ...
    post_type: Literal["notice"] | PredicateLike[Literal["notice"]]
    notice_type: (
        Literal["online_file_receive"] | PredicateLike[Literal["online_file_receive"]]
    )
    peer_id: int | PredicateLike[int]
...
class OnlineFileSendEventPattern(TypedDict, total=False):
    ...
    post_type: Literal["notice"] | PredicateLike[Literal["notice"]]
    notice_type: (
        Literal["online_file_send"] | PredicateLike[Literal["online_file_send"]]
    )
    peer_id: int | PredicateLike[int]
...
class PrivateMessageEventPattern(TypedDict, total=False):
    ...
    message_sent_type: str | None | PredicateLike[str | None]
    sub_type: (
        Literal["friend", "group"]
        | str
        | None
        | PredicateLike[Literal["friend", "group"] | str | None]
    )
    raw: Any | None | PredicateLike[Any | None]
    emoji_likes_list: (
        list[EmojiLikeItem] | None | PredicateLike[list[EmojiLikeItem] | None]
