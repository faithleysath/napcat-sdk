...
class NapCatResponse[T: ResponseDataBase](TypeValidatorMixin, IgnoreExtraArgsMixin):
    ...
    @classmethod
    def from_dict[U: ResponseDataBase](
        cls,
        data: dict[str, Any],  # <--- 修正点：必须叫 data，与 Mixin 保持一致
        data_type: type[U] | None = None,
    ) -> NapCatResponse[U]:
        """
